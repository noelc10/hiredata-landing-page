...
const chunkedData = computed(() => {
  return chunkData(JSON.parse(JSON.stringify(data?.value)), 2)
})
</script>
...
<template>
  <section
    ...
    class="bg-babyPowder-original py-20 sm:py-32"
  >
            ...
            >
              ...
              >
                <svg
                  ...
                  width="105"
                  height="78"
                  class="absolute left-6 top-6 fill-hd-secondary-50"
                >
                  <path
                ...
                >
                  <div>
                    <div class="font-display text-base text-slate-900">
                      {{ chunkedItemData.author }}
                    </div>
                    <div class="mt-1 text-sm text-slate-500">{{ chunkedItemData.role }}</div>
                  </div>
                  <div class="overflow-hidden rounded-full bg-slate-50">
                    <img
                      ...
                      alt=""
                      data-nuxt-img=""
                      :src="chunkedItemData.imgIcon"
                      :srcset="`
                        ${chunkedItemData.imgIcon} 1x,
                        ${chunkedItemData.imgIcon} 2x
                      `"
